...
// root-context에 bean으로 DataSource 등록 후 property로 셋터 설정 해주고 spring-jdbc 사용
...
//	
//	        DriverManagerDataSource ds = new DriverManagerDataSource();		//DriverManagerDataSource는 spring JDBC가 제공.
